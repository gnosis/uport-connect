...
var ConnectCore = function () {
  ...
  _createClass(ConnectCore, [{
    ...
    value: function request(_ref2) {
      ...
      this.isOnMobile && this.mobileUriHandler ? this.mobileUriHandler(uri) : uriHandler(uri, topic.cancel, this.appName, this.firstReq, explanation);
    ...
    */
    ...
    value: function sendTransaction(txobj, uriHandler) {
      ...
      return this.request({ uri: uri, topic: topic, uriHandler: uriHandler, explanation: txobj.explanation });
    }
